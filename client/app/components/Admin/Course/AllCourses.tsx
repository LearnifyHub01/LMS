...
const AllCourses = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const updatedCourses = allCourses.filter(course => course._id !== selectedCourse.id);
      ...
      renderCell: () => (
        <Button
          ...
          sx={{
            ...
            '&:hover': { color: theme === 'dark' ? '#45A049' : '#007BB5' },
            minWidth: 'auto',
            padding: 0,
          }}
        >
      ...
      >
        <Fade in={openModal}>
          ...
          >
            ...
            <Typography sx={{ mb: 3, color: theme === 'dark' ? '#ddd' : '#666' }}>
