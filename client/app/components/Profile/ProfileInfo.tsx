  ...
  return (
    <div className="flex flex-col min-h-screen  overflow-hidden bg-gray-100 dark:bg-[#121212]">
      <div className="flex flex-col md:flex-row gap-6 md:gap-0 max-w-full w-full md:py-0 flex-1">
        {/* Left Side: Profile Card */}
        <div
          className={`w-full md:w-[300px] bg-blue-400 dark:bg-[#1e1e2e] shadow-xl p-6 text-center border border-gray-200 dark:border-gray-800 flex flex-col items-center justify-start space-y-4 ${
        ...
        <div className="bg-white dark:bg-[#2a2e38] shadow-xl p-6 border border-gray-300 dark:border-gray-700 w-full md:w-2/3 flex-1 overflow-auto">
          <h3 className="text-lg md:text-xl font-semibold text-gray-700 dark:text-white mb-4 text-center">
            Edit Profile
          </h3>
          <form onSubmit={handleSubmit} className="space-y-4">
